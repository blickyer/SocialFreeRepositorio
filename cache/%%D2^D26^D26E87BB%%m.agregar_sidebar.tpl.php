<?php /* Smarty version 2.6.28, created on 2016-06-16 12:46:14
         compiled from modules/m.agregar_sidebar.tpl */ ?>
...
/js/jquery.form.js"></script>
                        ...
                        <form id="up_form" method="post" action="<?php echo $this->_tpl_vars['tsConfig']['url']; ?>
/upload-images.php" enctype="multipart/form-data">
                            <div class="clearfix">
                            <p class="floatL">
