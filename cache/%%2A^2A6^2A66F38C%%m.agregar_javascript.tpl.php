<?php /* Smarty version 2.6.28, created on 2016-06-16 12:46:14
         compiled from modules/m.agregar_javascript.tpl */ ?>
<script type="text/javascript">
//
var button_title = '     <?php if ($this->_tpl_vars['tsDraft']): ?>Aplicar Cambios<?php else: ?>Agregar post<?php endif; ?>     ';
// <?php echo '
...
function save_borrador(){
	var params = \'&titulo=\' + encodeURIComponent($(\'input[name="titulo"]\').val()) + \'&imagen=\' + encodeURIComponent($(\'input[name="imagen"]\').val()) + \'&cuerpo=\' + encodeURIComponent($(\'textarea[name="cuerpo"]\').val()) + \'&tags=\' + encodeURIComponent($(\'input[name="tags"]\').val()) + \'&categoria=\' + encodeURIComponent($(\'select[name="categoria"]\').val());
...
$(document).ready(function(){
    ...
    $(\'input[name=postPublic]\').bind(\'click\',function(){
    var error = false;
	...
	$(\'input[name=preview]\').bind(\'click\',function(){
		var error = false;
			...
			$.ajax({
				...
				data: \'&titulo=\' + encodeURIComponent($(\'input[name=titulo]\').val()) + \'&imagen=\' + encodeURIComponent($(\'input[name=imagen]\').val()) + \'&cuerpo=\' + encodeURIComponent($(\'textarea[name=cuerpo]\').val()),
				success: function(r) {
					mydialog.body(r);
