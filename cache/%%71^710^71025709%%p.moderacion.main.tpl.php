<?php /* Smarty version 2.6.28, created on 2016-06-16 12:40:28
         compiled from t.php_files/p.moderacion.main.tpl */ ?>
<div class="modalForm" style="margin:-15px 0;">
<?php if ($this->_tpl_vars['tsDo'] == 'aviso'): ?>
    <div class="m-col1">Para:</div>
    <div class="m-col2"><strong><?php echo $this->_tpl_vars['tsUsername']; ?>
</strong></div>
    <br style="clear:both"/>
    ...
    <br style="clear:both"/>
<?php elseif ($this->_tpl_vars['tsDo'] == 'ban'): ?>
