<?php /* Smarty version 2.6.28, created on 2016-06-16 12:46:00
         compiled from dinero/d.user_data.tpl */ ?>


   <div class="prindu">
     <a href="/perfil/<?php echo $this->_tpl_vars['tsDiner']['dinero']['user_name']; ?>
"><img src="/files/avatar/<?php echo $this->_tpl_vars['tsDiner']['dinero']['user_id']; ?>
_120.jpg"></a>
	 <span><p><b>Bienvenido</b> <?php echo $this->_tpl_vars['tsDiner']['dinero']['user_name']; ?>
 , desde aqu&iacute; podras controlar tus ingresos generados con tus</p>
   ...
   <div style="display:none;" id="vellenger" class="regd">
      <div class="box_title">
        <div class="box_txt bases_y_condiciones">Dinero por posts de <?php echo $this->_tpl_vars['tsConfig']['titulo']; ?>
</div>
    </div>
	<span>
...
, debe leerse completa y atentamente este documento.</p>
		...
		El pago se realizar&aacute; segun el sistema de pagos que establece <?php echo $this->_tpl_vars['tsConfig']['titulo']; ?>
 o un acuerdo de las partes.</p>
...
<table cellpadding="0" cellspacing="0" border="0" class="din_table" width="100%" align="center">
									...
									<tbody>
										<tr>
											<td>$ <?php echo $this->_tpl_vars['tsUser']->permisos['gopxd']; ?>
</td>
											<td>$ <?php if ($this->_tpl_vars['tsDiner']['dinero']['x_dinero'] == ''): ?>0<?php else: ?><?php echo $this->_tpl_vars['tsDiner']['dinero']['x_dinero']; ?>
<?php endif; ?></td>
											<td><?php echo $this->_tpl_vars['tsDiner']['dinero']['post_id']; ?>
</td>
											<td><?php echo $this->_tpl_vars['tsDiner']['dinero']['post_status']; ?>
</td>
											<td><?php echo $this->_tpl_vars['tsDiner']['dinero']['p_validate']; ?>
</td>
   										    <td><?php if (( $this->_tpl_vars['tsDiner']['dinero']['x_dinero'] >= $this->_tpl_vars['tsConfig']['dinerp'] ) && $this->_tpl_vars['tsDiner']['dinero']['uid_act'] == 0): ?>Disponible<?php else: ?>No Disponible<?php endif; ?></td>
										</tr>
									</tbody>
								</table>
