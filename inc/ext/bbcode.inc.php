...
class BBCode {
    ...
    public function addBBcodes() {
        ...
        $tagCodes = array(
            ...
            array('tag' => 'url', 'replace' => '<img alt="{param}" src="http://www.google.com/s2/favicons?domain={param}"><a href="{param}" target="_blank">{param}</a>', 'parse' => false, 'validParam' => $urlValidator),
            array('tag' => 'url', 'replace' => '<img alt="{param}" src="http://www.google.com/s2/favicons?domain={option}"><a href="{option}" target="_blank">{param}</a>', 'option' => true, 'validOption' => $urlValidator),
            ...
            array('tag' => 'slider', 'replace' => '<div id="slider-by-basdower" class="slider-kg bas-kg">{param}</div>')
        );
	...
	public function parseSmiles(){
	   global $tsCore;
        ...
        $bbcode[] = "(brb)"; $html[] = $pre."066.png".$end;
        $bbcode[] = ":^)"; $html[] = $pre."072.png".$end;
        $bbcode[] = "*-)"; $html[] = $pre."073.png".$end;
        $bbcode[] = "<o)"; $html[] = $pre."075.png".$end;
        $bbcode[] = "8-)"; $html[] = $pre."044.png".$end;
        ...
        $bbcode[] = "(lol)"; $html[] = $pre."089.png".$end;
        $bbcode[] = "(xD)"; $html[] = $pre."090.png".$end;
        $bbcode[] = "=8)"; $html[] = $pre."103.png".$end;
        $bbcode[] = ":8)"; $html[] = $pre."088.png".$end;
        $bbcode[] = "(ff)"; $html[] = $pre."091.png".$end;
        $bbcode[] = "(fm)"; $html[] = $pre."092.png".$end;
        $bbcode[] = ":'|"; $html[] = $pre."093.png".$end;
        $bbcode[] = ":]"; $html[] = $pre."094.png".$end;
        $bbcode[] = ":}"; $html[] = $pre."095.png".$end;
        $bbcode[] = "(BOO)"; $html[] = $pre."096.png".$end;
        $bbcode[] = "*|"; $html[] = $pre."097.png".$end;
        $bbcode[] = "*\\"; $html[] = $pre."098.png".$end;
        $bbcode[] = "(wm)"; $html[] = $pre."100.png".$end;
        $bbcode[] = "(xo)"; $html[] = $pre."101.png".$end;
        // OBJECTOS
        ...
        $bbcode[] = "(h5)"; $html[] = $pre."069.png".$end;
        ...
        $bbcode[] = ":luna:"; $html[] = $pre."102.png".$end;
        $bbcode[] = "(xx)"; $html[] = $pre."103.png".$end;
        $bbcode[] = ":megusta:"; $html[] = $pre."041.png".$end;
        $bbcode[] = ":nomegusta:"; $html[] = $pre."042.png".$end;
