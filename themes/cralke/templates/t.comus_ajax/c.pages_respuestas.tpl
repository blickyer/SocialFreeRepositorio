...
<div class="com_pagination">
    ...
    {/section}
    {if $tsRespuestas.pages.pages > 1 && $tsRespuestas.pages.pages > $tsRespuestas.pages.current}<a class="cp_next" href="javascript:com.pages_respuestas({$tsRespuestas.pages.next});"></a>{/if}
</div>
{/if}
