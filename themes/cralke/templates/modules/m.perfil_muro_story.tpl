                                    ...
                                    <div class="Story_Content">
                                        <div class="Story_Head">
                                            ...
                                            <div class="Story_Message">
                                                ...
                                                <div class="mvm clearfix">
                                                    {if $p.p_type == 2}
                                                    <a class="uiPhoto"><img src="{$p.a_img}"/></a>
                                                    {elseif $p.p_type == 3}
                                                    <div class="uiLink">
                                                    ...
                                                    <a href="#" onclick="muro.load_atta('video','{$p.a_url}', this); return false;"class="uiVideoThumb">
                                                        <img src="http://img.youtube.com/vi/{$p.a_url}/0.jpg" width="235" height="135"/>
                                                        <i></i>
                                                    </a>
                                                    <div class="videoDesc">
                                        ...
                                        <div class="Story_Foot">
                                            <div class="Story_Info">
                                                ...
                                                <a onclick="muro.like_this({$p.pub_id}, 'pub', this); return false;" class="a_blue text">{$p.likes.link}</a>
                                                <a onclick="muro.show_comment_box({$p.pub_id}); return false" class="a_blue text">Comentar</a>
                                                {if $tsUser->is_admod}
