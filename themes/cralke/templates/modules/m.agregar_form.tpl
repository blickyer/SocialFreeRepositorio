                        ...
                        <div class="form-add-post">
                        	<form action="{$tsConfig.url}/agregar.php{if $tsAction == 'editar'}?action=editar&pid={$tsPid}{/if}" method="post" name="newpost" autocomplete="off">
                                ...
                                <ul class="clearbeta">
                                    ...
                                    <span style="display: none;" class="errormsg"></span>
                                    <select class="agregar required" tabindex="5" size="9" style="width:260px; float:left" size="{$tsConfig.categorias.ncats}" name="categoria">
                                    <option value="" selected="selected" style="color: #000; font-weight: bold; padding: 3px; background:none;">Elegir una categor&iacute;a</option>
                                        ...
                                        <option value="{$c.cid}" {if $tsDraft.b_category == $c.cid}selected="selected"{/if} style="background-image:url({$tsConfig.tema.t_url}/mega/cat/{$c.c_img})">{$c.c_nombre}</option>
                                        {/foreach}
                                    </select>
                                    </li>
