                ...
                <div id="borradores">
                    ...
                    <div id="template-result-borrador" style="display:none">
                        <li id="borrador_id___id__">
                            ...
                            <span class="gray">&Uacute;ltima vez guardado el __fecha_guardado__</span> <a style="float:right" href="" onclick="borradores.eliminar(__borrador_id__, true); return false;"><img src="{$tsConfig.tema.t_url}/images/borrar.png" alt="eliminar" title="Eliminar Borrador" /></a>
