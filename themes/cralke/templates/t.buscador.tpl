        ...
        <div id="buscadorLite">
        	...
        	<div class="searchCont">
        		<form action="" method="GET" name="buscador">
        			<div class="searchFil">
        				<div style="">
        					<img{if $tsEngine != 'google'}style="display: none;margin-top: 5px;"{/if} alt="google-search-engine" src="http://www.google.com/images/poweredby_transparent/poweredby_FFFFFF.gif" id="buscador-logo-google"/>
        					<img{if $tsEngine != 'web'}style="display: none;margin-top: 5px;"{/if} alt="web-search-engine" style="margin-top: 5px;" src="{$tsConfig.default}/images/phpostmin.gif" id="buscador-logo-web"/>
        					<img{if $tsEngine != 'tags'} style="display: none;margin-top: 5px;"{/if} alt="tags-search-engine" src="{$tsConfig.default}/images/phpostmin.gif" id="buscador-logo-tags"/>
        ...
        <div id="resultados" style="width:770px" class="floatL">
            <div id="showResult">
                <table class="linksList">
                    <thead>
        				<tr>
        					<div class="resultados-busqueda" style="text-align: left;">Mostrando <strong>{$tsResults.total}</strong> de <strong>{$tsResults.pages.total}</strong> resultados totales</div>
        				</tr>
        			</thead>
                    <tbody>
                    ...
                    <tr id="div_{$r.post_id}">
                        <td style="text-align: left;">
						 <img class="cat-imgs" title="{$r.c_nombre}" src="{$tsConfig.tema.t_url}/images/icons/cat/{$r.c_img}"/>
                           <div style="display: inline-block;margin: 12px 8px;position: absolute;"> <a class="titlePost" href="{$tsConfig.url}/posts/{$r.c_seo}/{$r.post_id}/{$r.post_title|seo}.html">{$r.post_title}</a>
